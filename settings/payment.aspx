<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="payment.aspx.cs" Inherits="SampleApp.settings.payment" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <ContentTemplate>
        <div class="form-horizontal">
            ...
            <div class="form-group">
                <span class=" col-md-2">
                <asp:LinkButton ID="createPayment" runat="server" OnClick="createPayment_Click" >Create Payment Details</asp:LinkButton>
                </span>
            </div>
            <br />
            <div class="form-group">                
                <span class="col-md-4">
                 ...
                 <div class="col-md-2">
                     <br />
                     <asp:Button ID="btnsearch" runat="server" Text="Search" CssClass="btn btn-success" OnClick="btnsearch_Click1"  />
                 </div>
            </div>
        </div>
